...
description: Bluetooth ile çalışan uzaktan kumandal araba projesi
tags: ["Bluetooth", "DIY", "React Native"]
coverImage:
  src: "./yaratik.jpg"
  alt: "Uzaktan kumandalı arabanın fotoğrafı"
---
...
![Canavar uygulama ekranları](./canavarScreens.png)
